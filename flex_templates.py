        ...
        guide_contents.append({
            ...
            "contents": [
                ...
                },
                {
                    ...
                    "action": {"type": "message", "label": "設定" if not is_set else "修改", "text": f"設定 {cat} "}
                }
            ]
        })
    return {"type": "bubble", "body": {"type": "box", "layout": "vertical", "contents": guide_contents}}
            ...
            "contents": [
                ...
                {"type": "box", "layout": "vertical", "spacing": "xs", "contents": [
                    ...
                    {"type": "box", "layout": "vertical", "backgroundColor": "#eeeeee", "height": "6px", "cornerRadius": "3px",
                     "contents": [{"type": "box", "layout": "vertical", "width": f"{percent}%", "backgroundColor": color, "height": "6px", "cornerRadius": "3px"}]}
                ]}
            ]
        }
    }